                    ...
                    <span className='grid grid-cols-1 gap-5 place-items-center py-16 md:grid-cols-2'>
                        <span className='flex flex-col rounded-md py-7 px-6 gap-y-5 items-start justify-center w-full max-w-[30rem] border-[1px] border-solid border-[#939CA3]'>
                            <span className='flex items-center justify-start gap-x-3.5'>
                                <img src={'/Images/groups_black_24dp (1) 1.png'} alt="loading error" className='h-10 w-10' />
                        ...
                        <span className='flex flex-col rounded-md py-7 px-6 gap-y-5 items-start justify-center max-w-[30rem] w-full border-[1px] border-solid border-[#939CA3]'>
                            <span className='flex items-center justify-start gap-x-3.5'>
                                <img src={'/Images/location_on_black_24dp 1.png'} alt="loading error" className='h-10 w-10' />
                        ...
                        <span className='flex flex-col rounded-md py-7 px-6 gap-y-5 items-start justify-center max-w-[30rem] w-full border-[1px] border-solid border-[#939CA3]'>
                            <span className='flex items-center justify-start gap-x-3.5'>
                                <img src={'/Images/shopping_basket_black_24dp (2) 1.png'} alt="loading error" className='h-10 w-10' />
                        ...
                        <span className='flex flex-col rounded-md py-7 px-6 gap-y-5 items-start justify-center max-w-[30rem] w-full border-[1px] border-solid border-[#939CA3]'>
                            <span className='flex items-center justify-start gap-x-3.5'>
                                <img src={'/Images/event_available_black_24dp 2.png'} alt="loading error" className='h-10 w-10' />
                            ...
                            <button className='py-1 mt-5 px-5 rounded-md border-2 border-solid border-[#8064A2] text-[#8064A2]'>Attend</button>
                        </span>
                    </span>
                </div>
            </section>
